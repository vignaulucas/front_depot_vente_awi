...
export default function AdminList() {
    ...
    useEffect(() => {
        fetch(`${apiUrl}/user/managersAndAdmins`, {
            headers: {
    ...
    const filteredUsers = users.filter(user => (
        ...
        (roleFilter === 'tous' || user.role.toLowerCase() === roleFilter.toLowerCase())
    ));
        ...
        <ThemeProvider theme={theme}>
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <h1 className="filters-container font-bold mb-5">Liste des administrateurs et gestionnaires</h1>
                    ...
                    <div className="filters-container">
                        ...
                        <label>
                            <TripleSwitch initialOption={roleFilter} onChange={handleSwitchChange} />
                        </label>
                    </div>
                        ...
                        <tbody>
                            {filteredUsers.map(user => (
                                <tr key={user.idUser}>
                                    ...
                                    <td>{user.role === 'manager' ? 'gestionnaire' : user.role}</td>
                                    <td>{user.lastName}</td>
